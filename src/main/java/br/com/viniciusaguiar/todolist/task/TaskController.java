...
import br.com.viniciusaguiar.todolist.utils.Utils;
...
public class TaskController {
    ...
    // http://localhost:8080/tasks/89234777856-cvcowbeicbe
    @PutMapping("/{id}")
    public ResponseEntity update(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request){
        ...
        if(!task.getIdUser().equals(idUser)){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Usuário não tem autorização para alterar está tarefa!");
        }
